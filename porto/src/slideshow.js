...
function Slideshow() {
  return (
    <div className="py-4" >
        ...
        <div className='transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-cyan-500/50 duration-400 ...  container space-y-10 px-auto text-5xl shadow-xl  shadow-cyan-500/50 font-mono hover:' >Web Development
...
Experienced web developer proficient in React, HTML, CSS, JavaScript, and Tailwind CSS. Skilled in crafting dynamic and responsive interfaces using React, with a keen eye for visually appealing layouts through HTML and CSS. Efficiently utilizes Tailwind CSS for streamlined styling, contributing to polished and user-friendly digital experiences.</p>
        ...
        <div className='container space-y-10 px-auto text-5xl shadow-xl shadow-red-600/100 font-mono transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-red-600/50 duration-500 ...'>UI/UX Design
        ...
        <div className='container space-y-3 px-auto text-5xl shadow-xl font-mono shadow-orange-600/100 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 hover:bg-orange-600/50 duration-500 ...'>Cloud Computing
            <p className="text-sm font-sans">

...
Experienced web developer proficient in React, HTML, CSS, JavaScript, and Tailwind CSS. Skilled in crafting dynamic and responsive interfaces using React, with a keen eye for visually appealing layouts through HTML and CSS. Efficiently utilizes Tailwind CSS for streamlined styling, contributing to polished and user-friendly digital experiences.</p>
        ...
        <div className='container space-y-10 px-auto text-5xl shadow-xl shadow-blue-600/50 font-mono transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 max-md:text-3xl hover:bg-blue-500/50 duration-500 ...'>UI/UX Design
        ...
        <div className='container space-y-3 px-auto text-5xl shadow-xl font-mono shadow-blue-600/50 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 max-md:text-3xl hover:bg-blue-500/50 duration-500 ...'>Cloud Computing
            <p className="text-sm font-sans">
